...
public class TankPlayerHealth : MonoBehaviour
{
    ...
    [SerializeField]
    private float _damageEnemyShells; //para el daño que hacen las bolas enemigas
    ...
    //para llamarla y acudir al método público "GameOver()" del otro "Script"
    [Header("GameOver")]
    [SerializeField]
    ...
    private void OnTriggerEnter (Collider infoAccess)
    {
        if (infoAccess.CompareTag("EnemyShell"))
        {
            ...
            if (_currentHealth <= 0.0F) //si mi salud es menos o igual a cero 
            {
                ...
                _tankExplosion.Play();
                Death(); //llamo al método de la muerte
            }
